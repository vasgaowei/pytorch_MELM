...
int roi_ring_pooling_forward_cuda(int pooled_height, int pooled_width, float spatial_scale,
...
int roi_ring_pooling_backward_cuda(int pooled_height, int pooled_width, float spatial_scale,
